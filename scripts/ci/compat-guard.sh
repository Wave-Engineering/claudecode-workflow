...
#
# Run by CI on every PR — the `validate` job in .github/workflows/validate.yml (#1002) —
# and invokable locally. It sources the shared-state schema's committed BASELINE and
