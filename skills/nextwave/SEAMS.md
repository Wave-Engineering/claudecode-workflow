...
| trivy | `general-purpose` | `trivy fs --scanners vuln --severity HIGH,CRITICAL --include-dev-deps --list-all-pkgs --format json --quiet` on kahuna (#1169) | no HIGH/CRITICAL with available fixes |
